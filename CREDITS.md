...
**RPG Urban Pack** — Kenney (CC0 1.0 Universal)
- Source: https://opengameart.org/content/rpg-urban-pack
- File: `public/assets/kenney/rpg-urban-tilemap.png`
- Used for: character sprites (four directions, walk animation)

**\[16x16\] Indoor RPG Tileset** — armisius (CC-BY 3.0)
- Source: https://opengameart.org/content/16x16-indoor-rpg-tileset
- Author: https://tilation.itch.io/
...
Attribution for the CC-BY tileset (Indoor RPG Tileset by armisius) must stay in this file for any distribution of the game.
